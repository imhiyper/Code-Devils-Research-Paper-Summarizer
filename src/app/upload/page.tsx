...
export default function UploadFile() {
  ...
  const handlePlayAudio = async () => {
    try {
      ...
      const text = `This is the summary: ${summarizedText}. This is the key points: ${keyPoints}. This marks the end of the summariation and key points. Have a great day!`;
  ...
  return (
    <>
      <div className="bg-[#262626]">
        <a href="/">
          <h1 className="text-4xl mt-10 hover:scale-95 hover:text-slate-400 transition-all duration-300 ease-in-out transform text-slate-100 font-medium text-center">
            Swift Debrief
          </h1>
        </a>
